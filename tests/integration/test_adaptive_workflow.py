...
def test_query_variations_strategy_integration(
    real_llm, real_vector_store, real_embeddings
):
...
def test_confidence_scoring_integration(real_llm, real_vector_store, real_embeddings):
    ...
    if docs:
        ...
        confidence = scorer.score(
            question="What is Acme Corp's revenue?", answer=answer, documents=docs
        )
