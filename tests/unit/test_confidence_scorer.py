...
def test_confidence_scorer_heuristic():
    ...
    documents = [
        Document(
            page_content="Acme Corp revenue is $10M annually.",
            metadata={"source": "report.pdf"},
        ),
        Document(
            page_content="The company was founded in 2020.",
            metadata={"source": "info.pdf"},
        ),
        Document(
            page_content="Acme Corp is a technology company.",
    ...
    confidence_fail = scorer.score(
        question="What is the revenue?", answer="Not found", documents=[documents[0]]
    )
...
def test_confidence_scorer_with_different_answers(real_llm):
    ...
    low_conf = scorer.score(
        question="What is the revenue?", answer="I don't know", documents=documents
    )
